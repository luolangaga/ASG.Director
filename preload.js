...
const electronAPI = {
  ...
  getWindowsNativeNotificationSetting: () => ipcRenderer.invoke('windows-native-notification:get'),
  setWindowsNativeNotificationSetting: (enabled) => ipcRenderer.invoke('windows-native-notification:set', enabled),
