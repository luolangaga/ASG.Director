...
const { installProcessErrorGuards } = require('./src/shared/process-guards')
const { readJsonFileSafe, writeJsonFileSafe } = require('./src/shared/json-file')
...
registerBasicIpcHandlers({ ipcMain, BrowserWindow })
